...
You can then execute your native executable with: `./target/keycloak-endpoint-example-1.0.0-SNAPSHOT-runner`
...
- Camel Keycloak ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/keycloak.html)): Manage Keycloak instances via Admin API
